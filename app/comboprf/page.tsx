...
const authorityItems = [
  "Anos de experiência com mais de 20 aprovações juntas",
...
const faqItems = [
  ...
  },
  {
    ...
    resposta: "Sim. O material é mantido atualizado conforme as mudanças legislativas e os padrões de cobrança da banca.",
  },
]
    ...
    <main className="min-h-screen bg-black text-white overflow-x-hidden">
          ...
          <div className="px-4 sm:px-6 md:px-12 2xl:px-20 py-8 pt-[35vh] md:py-20 md:pt-20 pb-12 flex flex-col md:block items-center">
            ...
            >
              ...
              <motion.div variants={itemVariants} className="mb-10 w-full flex justify-center md:justify-start">
                <div onClick={() => setIsModalOpen(true)} className="w-full sm:w-auto cursor-pointer group">
      ...
      <section className="py-20 lg:py-28 relative bg-[#0a0a0a]" style={goldBorderStyle}>
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div onClick={() => setIsModalOpen(true)} className="mb-24">
